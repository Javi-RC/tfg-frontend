...
import { AlertTriangle, TrendingUp, Database, Filter, Search, RefreshCw, BookOpen, Code } from 'lucide-react';
    ...
    <div style={styles.metadataCard}>
      ...
      {expanded && (
        <div style={styles.metadataDetails}>
          {/* Typical Severities */}
          {metadata.typicalSeverities && metadata.typicalSeverities.length > 0 && (
          ...
          {/* Possible Sources */}
          {metadata.possibleSources && metadata.possibleSources.length > 0 && (
            <div style={styles.metadataSection}>
          ...
          {/* Trigger Conditions */}
          {metadata.triggerConditions && metadata.triggerConditions.length > 0 && (
            <div style={styles.metadataSection}>
          ...
          {metadata.supportedCountries && metadata.supportedCountries.length > 0 && (
            <div style={styles.metadataSection}>
          ...
          {/* Typical Indicators */}
          {metadata.typicalIndicators && metadata.typicalIndicators.length > 0 && (
            <div style={styles.metadataSection}>
          ...
          {metadata.typicalRecommendations && metadata.typicalRecommendations.length > 0 && (
            <div style={styles.metadataSection}>
