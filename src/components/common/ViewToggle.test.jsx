...
describe('ViewToggle', () => {
  ...
  it('renders all options', () => {
    render(<ViewToggle options={defaultOptions} activeView="grid" onChange={mockOnChange} />);
  ...
  it('renders icons when provided', () => {
    const { container } = render(
      <ViewToggle options={defaultOptions} activeView="grid" onChange={mockOnChange} />
    );
  ...
  it('renders without icons', () => {
    ...
    render(<ViewToggle options={optionsWithoutIcons} activeView="view1" onChange={mockOnChange} />);
  ...
  it('handles single option', () => {
    ...
    render(<ViewToggle options={singleOption} activeView="only" onChange={mockOnChange} />);
  ...
  it('handles many options', () => {
    ...
    render(<ViewToggle options={manyOptions} activeView="view1" onChange={mockOnChange} />);
  ...
  it('changes active view when prop updates', () => {
    ...
    rerender(<ViewToggle options={defaultOptions} activeView="list" onChange={mockOnChange} />);
  ...
  it('renders options with different value types', () => {
    ...
    render(<ViewToggle options={mixedOptions} activeView={1} onChange={mockOnChange} />);
  ...
  it('handles options with special characters', () => {
    ...
    render(<ViewToggle options={specialOptions} activeView="opt-1" onChange={mockOnChange} />);
