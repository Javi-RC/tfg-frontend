    ...
    return (
      <div style={styles.emptyContainer}>
        ...
        <p style={styles.emptyDescription}>
          {t('risk.manual.noRisksDescription')}
        </p>
      </div>
    );
  }
        ...
        {risks.map((risk) => (
          <div key={risk._id} style={styles.riskCard}>
            <div
              ...
              onClick={() => setExpandedRiskId(
                expandedRiskId === risk._id ? null : risk._id
              )}
            >
                ...
                {canManage && risk.source === 'manual' && (
                  <>
                    ...
                    <button
                      ...
                      title={deletingRiskId === risk._id ? t('risk.manual.confirmDelete') : t('risk.manual.deleteRisk')}
                    >
                      <Trash2 size={16} />
                    </button>
                  </>
