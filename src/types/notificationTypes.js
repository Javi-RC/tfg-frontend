...
export const getNotificationTypeLabel = (type) => {
  const labels = {
    ...
    [NOTIFICATION_TYPES.PROJECT_CREATED]: 'Proyecto Creado',
    [NOTIFICATION_TYPES.PROJECT_UPDATED]: 'Proyecto Actualizado',
    [NOTIFICATION_TYPES.PROJECT_DELETED]: 'Proyecto Eliminado',
    [NOTIFICATION_TYPES.PROJECT_ACTIVATED]: 'Proyecto Activado',
    [NOTIFICATION_TYPES.PROJECT_COMPLETED]: 'Proyecto Completado',
    [NOTIFICATION_TYPES.PROJECT_CANCELLED]: 'Proyecto Cancelado',
    [NOTIFICATION_TYPES.ASSIGNED_TO_PROJECT]: 'Asignado a Proyecto',
    [NOTIFICATION_TYPES.REMOVED_FROM_PROJECT]: 'Removido de Proyecto',
    [NOTIFICATION_TYPES.PROJECT_MANAGER_ROLE_ASSIGNED]: 'Asignado como Jefe de Proyecto',
    [NOTIFICATION_TYPES.PROJECT_MANAGER_ROLE_REMOVED]: 'Rol de Jefe de Proyecto Removido',
...
export const getNotificationTypeIcon = (type) => {
  const icons = {
    ...
    [NOTIFICATION_TYPES.PROJECT_ACTIVATED]: '✅',
    [NOTIFICATION_TYPES.PROJECT_COMPLETED]: '🎉',
    [NOTIFICATION_TYPES.PROJECT_CANCELLED]: '❌',
    [NOTIFICATION_TYPES.ASSIGNED_TO_PROJECT]: '👤',
    [NOTIFICATION_TYPES.REMOVED_FROM_PROJECT]: '👋',
    [NOTIFICATION_TYPES.PROJECT_MANAGER_ROLE_ASSIGNED]: '🎯',
    [NOTIFICATION_TYPES.PROJECT_MANAGER_ROLE_REMOVED]: '📊',
